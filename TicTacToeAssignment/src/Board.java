...
public class Board {
    ...
    public boolean isDraw() {
        ...
        // Hint: Use a nested loop (see the constructor for an example). Check whether any of the cells
        // content in the board grid are Player.Empty. If they are, it is not a draw.
